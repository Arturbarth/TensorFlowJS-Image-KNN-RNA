    ...
    var t = {
        ...
        l = {
            ...
            "2.00": {
                ...
                .75: "https://tfhub.dev/google/imagenet/mobilenet_v2_075_224/classification/2",
                "1.00": "https://tfhub.dev/google/imagenet/mobilenet_v2_100_224/classification/2"
            }
        };
    var s = function () {
        function e(e, a, o) {
            this.version = e, this.alpha = a, this.modelUrl = o, this.normalizationOffset = r.scalar(127.5)
        }
            ...
            return o(this, void 0, void 0, function () {
                ...
                return i(this, function (i) {
                    switch (i.label) {
                        ...
                        case 2:
                            return o = l[this.version][this.alpha], t = this, [4, a.loadGraphModel(o, {
                                fromTFHub: !0
                            })];
                        case 3:
                                ...
                                return o(this, void 0, void 0, function () {
                                    ...
                                    return i(this, function (i) {
                                        switch (i.label) {
                                            ...
                                            case 1:
                                                for (o = i.sent(), r.dispose(), n = [], u = 0; u < o.length; u++) n.push({
                                                    value: o[u],
                                                    index: u
                                                });
                                                for (n.sort(function (e, a) {
                                                    return a.value - e.value
                                                }), l = new Float32Array(a), s = new Int32Array(a), u = 0; u < a; u++) l[u] = n[u].value, s[u] = n[u].index;
                                                for (c = [], u = 0; u < s.length; u++) c.push({
                                                    className: t[s[u]],
                                                    probability: l[u]
                                                });
                                                return [2, c]
            ...
            return i(this, function (i) {
                switch (i.label) {
                    case 0:
                        ...
                        if (a = e.version.toFixed(2), o = e.alpha ? e.alpha.toFixed(2) : "", null == e.modelUrl) {
                            if (!(a in l)) throw new Error("Invalid version of MobileNet. Valid versions are: " + Object.keys(l));
                            if (!(o in l[a])) throw new Error("MobileNet constructed with invalid alpha " + e.alpha + ". Valid multipliers for this version are: " + Object.keys(l[a]) + ".")
                        }
                        return [4, (t = new s(a, o, e.modelUrl)).load()];
                    case 1:
                        return i.sent(), [2, t]
                }
            })
